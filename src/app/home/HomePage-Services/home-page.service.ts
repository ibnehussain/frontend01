...
export class HomePageService {
  ...
  getProducts():Observable<IProduct[]>{
    let tempVar = this.http.get<IProduct[]>('https://backendapp00125-fzbrbgbba6f3fubt.canadacentral-01.azurewebsites.net/api/home/getproducts')
    console.log(tempVar)
    return tempVar
  }
  ...
  ValidateUser(userEmailID:string, userPassword:string, type:string):Observable<number>
  {
    ...
    console.log(user)
    let result=this.http.post<number>('https://testloginfunctiona125.azurewebsites.net/api/LoginFunction?code=kDxJUURhVektI3q0G7_k0zea7O9yKG0FG-VfWfLqbLzpAzFuZJP6ww==',user)
    return result
